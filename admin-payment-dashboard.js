console.log("admin-payment-dashboard.js loaded");
...
// Approval in-flight locks
const approvalInFlightById = new Set();   // prevents same payment id being processed twice
let approvalModalBusy = false;            // prevents double-click on modal approve button
