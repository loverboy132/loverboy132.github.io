...
// Shared wallet conversion helpers
// 1 point = POINT_TO_NGN_RATE NGN
export function ngnToPoints(ngn) {
    return Math.floor((Number(ngn) || 0) / POINT_TO_NGN_RATE);
}

export function pointsToNgn(points) {
    return Math.round((Number(points) || 0) * POINT_TO_NGN_RATE);
}
